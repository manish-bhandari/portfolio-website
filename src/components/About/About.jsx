      ...
      <div className="about_content">
        <div className="about_data">
          ...
          <p>
            ...
            <span>full stack development, app development, and UI/UX.</span> I am
            always looking forward to learning new ideas, developing my skills,
            and making new connections. I am currently seeking a summer 2022
            internship.
          </p>
        </div>
